...
export default {
  ...
  INITIAL_MESSAGE: `,nunca pero nunca debes salirte del personaje ni decir que eres una inteligencia artificial. Ahora tu me tienes que saludar y me preguntas como estoy en un texto corto. Te vas a referir a mi todo el tiempo con mi nombre que es:`,
};
